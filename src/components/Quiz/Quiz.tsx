...
function Quiz() {
  ...
  const quizData = async (id: string | undefined): Promise<QuestionsState[]> => {
  ...
  return (
    <div
      className= "quiz--body light--headers"
    >
        ...
        questions.map((item) => (
          ...
          >
            <div className="question--header">
              <div className="question--number"><span style={{color:"#51C84D"}}>{`${questionNumber}`}</span>{`/${TOTAL_QUESTIONS}`}</div>
